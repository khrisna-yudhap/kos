		...
		<div class="col-xl-10">
			<div class="panel panel-inverse">
				...
				<div class="panel-heading">
					<h4 class="panel-title">Tabel Group </h4>
				...
				<div class="panel-body" style="border-bottom: 1px solid #ccc;">
					<div class="col-xl-12">
						<button onclick="window.open('<?= site_url('sistem/group/add') ?>', '_self')" class="btn btn-xs btn-primary"><i class="fa fa-plus"></i> Tambah</button>&nbsp;&nbsp;&nbsp;&nbsp;
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		table = $('#my-table').DataTable({
			...
			"ajax": {
				"url": '<?= site_url('sistem/group/index/json'); ?>',
				"type": "POST"
			},
		...
		$('#editBtn').click(function() {
			...
			if (oData.length > 0) {
				window.location.href = '<?= site_url('sistem/group/update/') ?>' + dataId;
			} else {
				$.gritter.add({
					...
					if (isConfirm) {
						swal({
							...
							$.ajax({
								...
								url: "<?= site_url('sistem/group_do/delete/') ?>" + dataId,
