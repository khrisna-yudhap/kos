...
<div id="content" class="content">
    ...
    <!-- end breadcrumb -->
    <!-- begin page-header -->
    <h1 class="page-header">List Kamar<small></small></h1>
    <!-- end page-header -->
    <!-- begin row -->
    <div class="row">
        <!-- begin col-12 -->
        <div class="col-xl-10">
            <div class="panel panel-inverse">
                ...
                <div class="panel-heading">
                    <h4 class="panel-title">Tabel Master Kamar</h4>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        table = $('#my-table').DataTable({
            ...
            "ajax": {
                "url": '<?= site_url('management/kamar/index/json'); ?>',
                "type": "POST"
            },
