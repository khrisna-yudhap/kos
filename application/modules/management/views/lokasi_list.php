                    ...
                    <table id="my-table" class="table table-striped table-bordered table-td-valign-middle">
                        <thead>
                            <tr>
                                ...
                                <th class="text-nowrap">Kabupaten / Kota</th>
                            </tr>
                        </thead>
                        <tbody>
                        </tbody>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        table = $('#my-table').DataTable({
            ...
            "ajax": {
                "url": '<?= site_url('management/lokasi/index/json'); ?>',
                "type": "POST"
            },
        ...
        $('#editBtn').click(function() {
            ...
            if (oData.length > 0) {
                window.location.href = '<?= site_url('management/lokasi/update/') ?>' + dataId;
            } else {
                $.gritter.add({
                    ...
                    if (isConfirm) {
                        swal({
                            ...
                            $.ajax({
                                ...
                                url: "<?= site_url('management/lokasi_do/delete/') ?>" + dataId,
