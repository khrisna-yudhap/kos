...
<div id="content" class="content">
	...
	<ol class="breadcrumb float-xl-right">
		...
		<li class="breadcrumb-item active">Ref Billing</li>
	</ol>
	<!-- end breadcrumb -->
	<!-- begin page-header -->
		...
		<div class="col-xl-10">
			<div class="panel panel-inverse">
				...
				<div class="panel-heading">
					<h4 class="panel-title">Tabel Ref Billing </h4>
				...
				<div class="panel-body" style="border-bottom: 1px solid #ccc;">
					<div class="col-xl-12">
						<button onclick="window.open('<?= site_url('master/ref_billing/add') ?>', '_self')" class="btn btn-xs btn-primary"><i class="fa fa-plus"></i> Tambah</button>&nbsp;&nbsp;&nbsp;&nbsp;
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		table = $('#my-table').DataTable({
			...
			"ajax": {
				"url": '<?= site_url('master/ref_billing/index/json'); ?>',
				"type": "POST"
			},
		...
		$('#editBtn').click(function() {
			...
			if (oData.length > 0) {
				window.location.href = '<?= site_url('master/ref_billing/update/') ?>' + dataId;
			} else {
				$.gritter.add({
					...
					if (isConfirm) {
						swal({
							...
							$.ajax({
								...
								url: "<?= site_url('master/ref_billing_do/delete/') ?>" + dataId,
